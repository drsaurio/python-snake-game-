...
def main():
    ...
    while 1:
        ...
        pygame.mixer.init()
        pygame.mixer.music.load('rezo2.wav')
        ...
        if showstartscreen == TRUE:
            ...
            for e in s:
                ...
                pygame.display.flip()
                clock.tick(8)
            background = pygame.image.load('snaky2.png').convert()
            screen.blit(background,(375,100))
            
            font = pygame.font.SysFont("courier", 64)
            text_surface = font.render("naky", True, GREEN)
            screen.blit(text_surface, (220,180))
            font = pygame.font.SysFont("corier", 20)
            ...
            text_surface = font.render("Press S to start a new game - Press Q to quit", True, BLUE)
        ...
        while not snakedead:
            ...
            text_surface = font.render("Snaky!          Score: " + str(score), True, GREEN)
        ...
        if snakedead == TRUE:
            ...
            text_surface = font.render("GAME OVER", True, PURPLE)
            background = pygame.image.load('snaky.png').convert()
            screen.blit(background,(310,100))
            screen.blit(text_surface, (280,200))
            text_surface = font.render("Your Score: " + str (score), True, BLUE)
            screen.blit(text_surface, (280,300))
